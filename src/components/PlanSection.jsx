    ...
    <section className="plan-section" ref={ref}>
        ...
        <div className="plan-container">
          <div className="plans">
            {plans.map((plan, index) => (
              <div
                key={index}
                className={`plan-box ${plan.recommended ? "recommended" : ""}`}
              >
                {plan.recommended && (
                  <span className="recommended-label">Recomendado</span>
                )}
                <p className="plan-name">{plan.name}</p>
                <p className="plan-price">{plan.price}</p>
                <p className="plan-description">
                  {plan.recommended ? plan.discount : plan.description}
                </p>
      ...
      {isMobile && (
        <div className="mobile-plan-container">
          <button className="nav-button" onClick={handlePrevPlan}>
            ◀
          </button>
          <div className="mobile-plan-box">
            <div
              className={`plan-box ${
                plans[currentPlanIndex].recommended ? "recommended" : ""
              }`}
            >
              ...
              <p className="plan-description">
                {plans[currentPlanIndex].recommended
                  ? plans[currentPlanIndex].discount
                  : plans[currentPlanIndex].description}
              </p>
              <button className="plan-button">Escoge este ➜</button>
            </div>
          </div>
          <button className="nav-button" onClick={handleNextPlan}>
            ▶
          </button>
        </div>
      )}
